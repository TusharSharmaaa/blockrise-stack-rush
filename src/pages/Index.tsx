...
import { Play, Trophy, Calendar, Settings as SettingsIcon, Layers, ShoppingBag, User } from "lucide-react";
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-4">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <Badge variant="neon" className="text-xs">Level {selectedLevel}</Badge>
            </div>
            <div>
