            ...
            <div className="bg-background/80 rounded-lg p-2 sm:p-3 md:p-4 flex items-center gap-2 sm:gap-3 md:gap-4 overflow-hidden">
              ...
              <div className="flex-1 min-w-0 overflow-hidden">
                <div className="flex items-center gap-1.5 sm:gap-2 mb-0.5 sm:mb-1">
                  <span className="text-base sm:text-xl md:text-2xl flex-shrink-0">{getCountryFlag(userPosition.entry?.country || '')}</span>
                ...
                <div className="flex items-center gap-0.5 sm:gap-1 md:gap-2 text-[10px] sm:text-xs md:text-sm text-muted-foreground overflow-hidden flex-wrap">
                  ...
                  <span className="truncate min-w-0">{userPosition.entry?.city}, {userPosition.entry?.country}</span>
                  <span className="mx-0.5 sm:mx-1 flex-shrink-0">•</span>
                  <span className="whitespace-nowrap flex-shrink-0">Lvl {userPosition.entry?.level}</span>
                  <span className="mx-0.5 sm:mx-1 flex-shrink-0">•</span>
                  <span className="whitespace-nowrap flex-shrink-0">#{userPosition.rank} of {userPosition.totalPlayers}</span>
                </div>
              </div>
              <div className="text-right flex-shrink-0 ml-1 sm:ml-2">
                <div className="text-base sm:text-xl md:text-2xl font-bold text-primary whitespace-nowrap">{userPosition.entry?.score.toLocaleString()}</div>
